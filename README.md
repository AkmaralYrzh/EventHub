...
Дипломный проект курса iOS-разработки (Astana Hub, 2026).
...
- Лимит мест: организатор задаёт количество (или не задаёт), при заполнении запись закрывается — проверка в транзакции Firestore
- В ленте только предстоящие события; прошедшие — в профиле
...
| Тесты | XCTest — 23 unit-теста (модели, фильтрация, валидация даты, состояния) |
